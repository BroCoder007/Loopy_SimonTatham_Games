...
class StrategyController:
    def __init__(self, game_state: Any, mode: str):
        ...
        self.constraint_solver = ConstraintBacktrackingSolver(game_state)
    ...
    def get_next_cpu_move(self) -> Tuple[Optional[Any], str]:
        ...
        if self.selected_mode == "constraint_propagation":
            move = self._try_solver(self.constraint_solver)
            if move is not None:
                return move, "Constraint Propagation"
            return None, "No moves available"
    ...
    def get_solver_for_source(self, source: str) -> Optional[Any]:
        ...
        if source == "Constraint Propagation":
    ...
    def _normalize_mode(self, mode: str) -> str:
        ...
        if mode in ("constraint_propagation", "constraint", "csp"):
